            ...
            @if ($showingQrCode)
                <div class="mt-4 max-w-xl text-sm text-gray-600">
                    <p class="font-semibold">
                        @if ($showingConfirmation)
                            {{ __('Para concluir a ativação da autenticação de dois fatores, leia o seguinte código QR usando seu telefone\'s aplicativo autenticador ou insira a chave de configuração e forneça o código OTP gerado.') }}
                        @else
